interface Resources {
  commons: {
    ...
    "ai-client": {
      openai: {
        "requires-response-api-online-search": "使用联网搜索功能需要开启 Responses API 设置";
        "requires-response-api-pdf": "使用 PDF 识别功能需要开启 Responses API 设置";
    ...
    "settings-page": {
      ...
      "api-credentials": {
        advanced: {
          "custom-url": "自定义 URL";
          "enable-response-api": "启用 Responses API";
          "openai-default": "OpenAI (默认)";
          openrouter: "OpenRouter";
          "quick-preset": "快捷调整服务提供商";
          "quick-preset-placeholder": "选择预设提供商...";
          "response-api-tip": "提示: 启用 Responses API 后，OpenAI 模型可读取 PDF 并进行联网搜索。未启用此 API 时，这些功能不可用。";
